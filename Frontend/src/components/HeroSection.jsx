                ...
                <div className="container mx-auto px-4 h-full flex items-center">
                    <div className="max-w-3xl text-white z-10 relative">
                        ...
                        <div className="flex gap-4">
                            <Link
                                to="/our_packages"
                                className="bg-[#F29404] hover:bg-[#DB8303] px-8 py-3 rounded-lg font-semibold transition-all transform hover:scale-105"
                            >
                                Explore Tours
                            </Link>
                            <button
                                onClick={() => setShowCustomModal(true)}
                                className="border-2 border-white hover:bg-white hover:text-purple-900 px-8 py-3 rounded-lg font-semibold transition-colors"
                            >
                                Custom Trip
                            </button>
                        </div>
